...
const availableComponents = ref([
  ...
  { component_type: 'paragraph', content: 'This is a new paragraph.', label: 'Paragraph', styles: {}, order: 2 },
...
const availableSections = ref([
  {
    ...
    components: [
      ...
      { component_type: 'paragraph', content: 'A compelling subtitle that explains your value proposition.', styles: {}, order: 2 }
    ]
  },
  {
    ...
    components: [
      ...
      { component_type: 'paragraph', content: 'Describe a key benefit.', styles: {}, order: 2 },
      { component_type: 'heading', content: 'Feature Two', styles: { fontSize: '1.5rem', color: '#333' }, order: 3 },
      { component_type: 'paragraph', content: 'Describe another key benefit.', styles: {}, order: 4 },
      { component_type: 'heading', content: 'Feature Three', styles: { fontSize: '1.5rem', color: '#333' }, order: 5 },
      { component_type: 'paragraph', content: 'Describe a final key benefit.', styles: {}, order: 6 },
    ]
  }
])
...
const cloneItem = (item: any) => {
  ...
  if (newItem.components) {
    newItem.components.forEach((comp: any) => {
...
<style scoped>
.library-panel{width:280px;background-color:#21252b;border-right:1px solid #3c4049;display:flex;flex-direction:column}.panel-header{display:flex;flex-shrink:0;border-bottom:1px solid #3c4049}.panel-header button{flex:1;padding:16px;background:transparent;border:none;color:#6b7280;font-size:1rem;font-weight:700;cursor:pointer;transition:all .2s ease;border-bottom:2px solid transparent}.panel-header button:hover{color:#fff}.panel-header button.active{color:#fff;border-bottom-color:#a855f7}.panel-content{padding:16px;overflow-y:auto}.library-item{padding:12px 16px;background-color:#282c34;border:1px solid #3c4049;border-radius:6px;color:#abb2bf;font-weight:600;margin-bottom:12px;cursor:grab;transition:all .2s ease}.library-item:hover{background-color:#3c4049;border-color:#a855f7;color:#fff}
</style>